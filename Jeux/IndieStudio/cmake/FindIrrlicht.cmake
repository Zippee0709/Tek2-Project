...
set(Irrlicht_DIR "${CMAKE_CURRENT_SOURCE_DIR}/irrlicht-1.8.4")
...
IF (NOT Irrlicht_INCLUDE_DIRS OR NOT Irrlicht_LIBRARIES)
  ...
  FIND_LIBRARY(Irrlicht_LIBRARIES
    ...
    PATHS
      ...
      ${Irrlicht_DIR}/lib/Linux              # Irrlicht root directory (if provided)
      ${Irrlicht_DIR}/lib/Win32-visualstudio              # Irrlicht root directory (if provided)
  )
